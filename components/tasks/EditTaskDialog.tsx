          ...
          <div className="flex-1 overflow-y-auto px-4 sm:px-6 pb-4 sm:pb-6 min-h-0">
            <div className="space-y-3 sm:space-y-4 min-w-0">
              ...
              <div className="space-y-2 min-w-0">
                <Label htmlFor="edit-task-description" className="text-xs sm:text-sm">{t('projects.description')}</Label>
                <div className={cn("border border-gray-200 dark:border-gray-800 rounded-lg", readOnly && "opacity-60")}>
                  <MarkdownEditor
                    value={description}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-task-duration" className="text-xs sm:text-sm">{t('tasks.estimatedTime')}</Label>
                  <Input
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-2.5 sm:p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <div className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">{t('tasks.timeStatus')}</div>
